...
GlobalVariableData* ZilchShaderIRModule::FindFragmentSharedVariable(const FragmentSharedKey& key, bool checkDependencies)
{
...
GlobalVariableData* ZilchShaderIRLibrary::FindFragmentSharedVariable(const FragmentSharedKey& key, bool checkDependencies)
{
