...
void ZilchSpirVFrontEnd::ValidateAttributeParameters(ShaderIRAttribute* shaderAttribute, HashMap<String, AttributeInfo>& allowedAttributes, StringParam errorTypeName)
{
...
bool ZilchSpirVFrontEnd::ValidateAttributeParameterSignature(ShaderIRAttribute* shaderAttribute, const AttributeInfo::ParameterSignature& signature) const
{
...
bool ZilchSpirVFrontEnd::DoTypesMatch(const AttributeInfo::ParamType& actualType, const AttributeInfo::ParamType& expectedType) const
{
...
void ZilchSpirVFrontEnd::AddRuntimeArray(Zilch::MemberVariableNode* node, ZilchShaderIRType* varType, ShaderIRFieldMeta* fieldMeta, ZilchSpirVFrontEndContext* context)
{
...
void ZilchSpirVFrontEnd::AddGlobalVariable(Zilch::MemberVariableNode* node, ZilchShaderIRType* varType, ShaderIRFieldMeta* fieldMeta, spv::StorageClass storageClass, ZilchSpirVFrontEndContext* context)
{
...
GlobalVariableData* ZilchSpirVFrontEnd::CreateGlobalVariable(spv::StorageClass storageClass, ZilchShaderIRType* varType, StringParam varName, ZilchSpirVFrontEndContext* context)
{
...
void ZilchSpirVFrontEnd::GetFunctionCallArguments(Zilch::FunctionCallNode* node, Zilch::MemberAccessNode* memberAccessNode, Array<IZilchShaderIR*>& arguments, ZilchSpirVFrontEndContext* context)
{
...
void ZilchSpirVFrontEnd::GetFunctionCallArguments(Zilch::FunctionCallNode* node, IZilchShaderIR* thisOp, Array<IZilchShaderIR*>& arguments, ZilchSpirVFrontEndContext* context)
{
...
void ZilchSpirVFrontEnd::WriteFunctionCallArgument(IZilchShaderIR* argument, ZilchShaderIROp* functionCallOp, ZilchShaderIRType* paramType, ZilchSpirVFrontEndContext* context)
{
  ...
  else if(paramType->IsPointerType())
  {
    ...
    if(requiresCopyArgument)
    {
      ...
      ZilchShaderIRType* localVarPointerType = FindOrCreatePointerInterfaceType(mLibrary, paramType->mDereferenceType, paramType->mStorageClass);
...
void ZilchSpirVFrontEnd::WriteFunctionCall(Array<IZilchShaderIR*> arguments, ZilchShaderIRFunction* shaderFunction, ZilchSpirVFrontEndContext* context)
{
  // Generate the function call but don't add it to the block yet (so we can collect all arguments first)
