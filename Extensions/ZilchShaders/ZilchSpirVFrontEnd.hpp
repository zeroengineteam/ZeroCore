...
public:
  ...
  void AddRuntimeArray(Zilch::MemberVariableNode* node, ZilchShaderIRType* varType, ShaderIRFieldMeta* fieldMeta, ZilchSpirVFrontEndContext* context);
  void AddGlobalVariable(Zilch::MemberVariableNode* node, ZilchShaderIRType* varType, ShaderIRFieldMeta* fieldMeta, spv::StorageClass storageClass, ZilchSpirVFrontEndContext* context);
  GlobalVariableData* CreateGlobalVariable(spv::StorageClass storageClass, ZilchShaderIRType* varType, StringParam varName, ZilchSpirVFrontEndContext* context);
